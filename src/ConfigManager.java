public class ConfigManager {
    static Configurations getClientConfigurations(int id) {
        ...
        configurations.allProdClients = new String[]{"dc01.utdallas.edu:5001", "dc02.utdallas.edu:5002", "dc03.utdallas.edu:5003", "dc04.utdallas.edu:5004", "dc05.utdallas.edu:5005"};
        ...
        switch (id) {
            case 1:
                ...
                configurations.prodClients = new String[]{"dc02.utdallas.edu:5002", "dc03.utdallas.edu:5003"};
            ...
            case 2:
                ...
                configurations.prodClients = new String[]{"dc03.utdallas.edu:5003", "dc04.utdallas.edu:5004"};
                configurations.prodServers = new String[]{"dc01.utdallas.edu:6000", "dc02.utdallas.edu:6000", "dc03.utdallas.edu:6000"};
                break;
            case 3:
                ...
                configurations.prodClients = new String[]{"dc04.utdallas.edu:5004", "dc05.utdallas.edu:5005"};
                configurations.prodServers = new String[]{"dc01.utdallas.edu:6000", "dc02.utdallas.edu:6000", "dc03.utdallas.edu:6000"};
                break;
            case 4:
                ...
                configurations.prodClients = new String[]{"dc05.utdallas.edu:5005", "dc01.utdallas.edu:5001"};
                configurations.prodServers = new String[]{"dc01.utdallas.edu:6000", "dc02.utdallas.edu:6000", "dc03.utdallas.edu:6000"};
                break;
            case 5:
                ...
                configurations.prodClients = new String[]{"dc01.utdallas.edu:5001", "dc02.utdallas.edu:5002"};
                configurations.prodServers = new String[]{"dc01.utdallas.edu:6000", "dc02.utdallas.edu:6000", "dc03.utdallas.edu:6000"};
                break;
        }
